          ...
          )
{
    ...
    {
        STRESS_LOG1(LF_CORDB, LL_ERROR, "RtlVirtualUnwind is about to fail b/c the ControlPc (%p) is in the epilog of a function which has a 0xCC in its epilog.", ControlPc);
