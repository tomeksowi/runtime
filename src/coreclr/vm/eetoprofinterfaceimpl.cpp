...
UINT_PTR EEToProfInterfaceImpl::EEFunctionIDMapper(FunctionID funcId, BOOL * pbHookFunction)
{
    ...
    if (m_pProfilersFuncIDMapper2 != NULL)
    {
        CLR_TO_PROFILER_ENTRYPOINT((LF_CORPROF,
                                    LL_INFO100,
                                    "**PROF: Calling profiler's FunctionIDMapper2. funcId: %p. clientData: %p.\n",
                                    funcId,
    ...
    else
    {
        CLR_TO_PROFILER_ENTRYPOINT((LF_CORPROF,
                                    LL_INFO100,
                                    "**PROF: Calling profiler's FunctionIDMapper. funcId: %p.\n",
                                    funcId));
                                              ...
                                              void * pHeapId)
{
    ...
    LOG((LF_CORPROF, LL_INFO100000, "**PROF: Root Reference. "
            "ObjectID:%p dwEtwRootKind:0x%x dwEtwRootFlags:0x%x rootId:%p HeadId:%p\n",
                        ...
                        void * pHeapId)
{
    ...
    LOG((LF_CORPROF, LL_INFO100000, "**PROF: Root Dependent Handle. "
            "PrimaryObjectID:%p SecondaryObjectID:%p rootId:%p HeadId:%p\n",
...
HRESULT EEToProfInterfaceImpl::ThreadCreated(ThreadID threadId)
{
    ...
    CLR_TO_PROFILER_ENTRYPOINT_FOR_THREAD(threadId,
                                          (LF_CORPROF,
                                           LL_INFO100,
                                           "**PROF: Notifying profiler of created thread. ThreadId: %p.\n",
                                           threadId));
...
HRESULT EEToProfInterfaceImpl::ThreadDestroyed(ThreadID threadId)
{
    ...
    CLR_TO_PROFILER_ENTRYPOINT_FOR_THREAD(threadId,
                                          (LF_CORPROF,
                                           LL_INFO100,
                                           "**PROF: Notifying profiler of destroyed thread. ThreadId: %p.\n",
                                           threadId));
                                                        ...
                                                        DWORD osThreadId)
{
    ...
    CLR_TO_PROFILER_ENTRYPOINT_FOR_THREAD_EX(
        ...
        (LF_CORPROF,
        LL_INFO100,
        "**PROF: Notifying profiler of thread assignment.  ThreadId: %p, OSThreadId: 0x%08x\n",
        managedThreadId,
        osThreadId));
                                                      ...
                                                      BOOL fIsSafeToBlock)
{
    ...
    CLR_TO_PROFILER_ENTRYPOINT((LF_CORPROF,
                                LL_INFO1000,
                                "**PROF: JITCompilationFinished %p, hr=0x%08x.\n",
                                functionId,
                                hrStatus));
                                                                   ...
                                                                   BOOL fIsSafeToBlock)
{
    ...
    CLR_TO_PROFILER_ENTRYPOINT((LF_CORPROF,
                                LL_INFO1000,
                                "**PROF: DynamicMethodJITCompilationFinished %p.\n",
                                functionId));
                                                                  ...
                                                                  ULONG cbILHeader)
{
    ...
    CLR_TO_PROFILER_ENTRYPOINT((LF_CORPROF,
                                LL_INFO1000,
                                "**PROF: DynamicMethodJITCompilationStarted %p.\n",
                                functionId));
                                    ...
                                    /* [out] */ BOOL       *pbUseCachedFunction)
{
    ...
    CLR_TO_PROFILER_ENTRYPOINT((LF_CORPROF,
                                LL_INFO1000,
                                "**PROF: JITCachedFunctionSearchStarted %p.\n",
                                functionId));
    _ASSERTE(functionId);
                                    ...
                                    /* [in] */  COR_PRF_JIT_CACHE result)
{
    ...
    CLR_TO_PROFILER_ENTRYPOINT((LF_CORPROF,
                                LL_INFO1000,
                                "**PROF: JITCachedFunctionSearchFinished %p, %s.\n",
                                functionId,
    ...
    /* [out] */ BOOL *        pfShouldInline)
{
    ...
    CLR_TO_PROFILER_ENTRYPOINT((LF_CORPROF,
                                LL_INFO1000,
                                "**PROF: JITInlining caller: %p, callee: %p.\n",
                                callerId,
                                calleeId));
    ...
    /* [in] */  BOOL          fIsSafeToBlock)
{
    ...
    CLR_TO_PROFILER_ENTRYPOINT((LF_CORPROF,
                                LL_INFO1000,
                                "**PROF: ReJITCompilationStarted %p %p.\n",
                                functionId, reJitId));
    ...
    /* [in] */  BOOL          fIsSafeToBlock)
{
    ...
    CLR_TO_PROFILER_ENTRYPOINT((LF_CORPROF,
                                LL_INFO1000,
                                "**PROF: ReJITCompilationFinished %p %p hr=0x%x.\n",
    ...
    AssemblyID  AssemblyId)
{
    ...
    CLR_TO_PROFILER_ENTRYPOINT((LF_CORPROF,
                                LL_INFO10,
                                "**PROF: ModuleAttachedToAssembly %p, %p.\n",
                                moduleId,
                                AssemblyId));
...
HRESULT EEToProfInterfaceImpl::ModuleInMemorySymbolsUpdated(ModuleID moduleId)
{
    ...
    CLR_TO_PROFILER_ENTRYPOINT((LF_CORPROF,
        LL_INFO10,
        "**PROF: ModuleInMemorySymbolsUpdated.  moduleId: %p.\n",
        moduleId
        ));
    HRESULT hr = S_OK;
    ...
    HRESULT     hrStatus)
{
    ...
    CLR_TO_PROFILER_ENTRYPOINT((LF_CORPROF,
                                LL_INFO100,
                                "**PROF: ClassLoadFinished %p, 0x%08x.\n",
                                classId,
                                hrStatus));
    ...
    HRESULT     hrStatus)
{
    ...
    CLR_TO_PROFILER_ENTRYPOINT((LF_CORPROF,
                                LL_INFO100,
                                "**PROF: ClassUnloadFinished %p, 0x%08x.\n",
                                classId,
                                hrStatus));
    ...
    AppDomainID appDomainId)
{
    ...
    CLR_TO_PROFILER_ENTRYPOINT((LF_CORPROF,
                                LL_INFO10,
                                "**PROF: AppDomainCreationStarted %p.\n",
                                appDomainId));
    ...
    HRESULT     hrStatus)
{
    ...
    CLR_TO_PROFILER_ENTRYPOINT((LF_CORPROF,
                                LL_INFO10,
                                "**PROF: AppDomainCreationFinished %p, 0x%08x.\n",
                                appDomainId,
                                hrStatus));
    ...
    AppDomainID appDomainId)
{
    ...
    CLR_TO_PROFILER_ENTRYPOINT((LF_CORPROF,
                                LL_INFO10,
                                "**PROF: AppDomainShutdownStarted %p.\n",
                                appDomainId));
    ...
    HRESULT     hrStatus)
{
    ...
    CLR_TO_PROFILER_ENTRYPOINT((LF_CORPROF,
                                LL_INFO10,
                                "**PROF: AppDomainShutdownFinished %p, 0x%08x.\n",
                                appDomainId,
                                hrStatus));
    ...
    HRESULT     hrStatus)
{
    ...
    CLR_TO_PROFILER_ENTRYPOINT((LF_CORPROF,
                                LL_INFO10,
                                "**PROF: AssemblyLoadFinished %p, 0x%08x.\n",
                                assemblyId,
                                hrStatus));
    ...
    HRESULT     hrStatus)
{
    ...
    CLR_TO_PROFILER_ENTRYPOINT((LF_CORPROF,
                                LL_INFO10,
                                "**PROF: AssemblyUnloadFinished %p, 0x%08x.\n",
                                assemblyId,
                                hrStatus));
    ...
    COR_PRF_TRANSITION_REASON reason)
{
    ...
    CLR_TO_PROFILER_ENTRYPOINT((LF_CORPROF,
                                LL_INFO10000,
                                "**PROF: UnmanagedToManagedTransition %p.\n",
                                functionId));
    ...
    COR_PRF_TRANSITION_REASON reason)
{
    ...
    CLR_TO_PROFILER_ENTRYPOINT((LF_CORPROF,
                                LL_INFO10000,
                                "**PROF: ManagedToUnmanagedTransition %p.\n",
                                functionId));
    ...
    ObjectID thrownObjectId)
{
    ...
    CLR_TO_PROFILER_ENTRYPOINT((LF_CORPROF,
                                LL_INFO1000,
                                "**PROF: ExceptionThrown. ObjectID: %p. ThreadID: %p\n",
                                thrownObjectId,
                                GetThreadNULLOk()));
    ...
    FunctionID functionId)
{
    ...
    CLR_TO_PROFILER_ENTRYPOINT((LF_CORPROF,
                                LL_INFO1000,
                                "**PROF: ExceptionSearchFunctionEnter. ThreadID: %p, functionId: %p\n",
                                GetThreadNULLOk(),
                                functionId));
...
HRESULT EEToProfInterfaceImpl::ExceptionSearchFunctionLeave()
{
    ...
    CLR_TO_PROFILER_ENTRYPOINT((LF_CORPROF,
                                LL_INFO1000,
                                "**PROF: ExceptionSearchFunctionLeave. ThreadID: %p\n",
                                GetThreadNULLOk()));
...
HRESULT EEToProfInterfaceImpl::ExceptionSearchFilterEnter(FunctionID functionId)
{
    ...
    CLR_TO_PROFILER_ENTRYPOINT((LF_CORPROF,
                                LL_INFO1000,
                                "**PROF: ExceptionSearchFilterEnter. ThreadID: %p, functionId: %p\n",
                                GetThreadNULLOk(),
                                functionId));
...
HRESULT EEToProfInterfaceImpl::ExceptionSearchFilterLeave()
{
    ...
    CLR_TO_PROFILER_ENTRYPOINT((LF_CORPROF,
                                LL_INFO1000,
                                "**PROF: ExceptionFilterLeave. ThreadID: %p\n",
                                GetThreadNULLOk()));
...
HRESULT EEToProfInterfaceImpl::ExceptionSearchCatcherFound(FunctionID functionId)
{
    ...
    CLR_TO_PROFILER_ENTRYPOINT((LF_CORPROF,
                                LL_INFO1000,
                                "**PROF: ExceptionSearchCatcherFound.  ThreadID: %p\n",
                                GetThreadNULLOk()));
...
HRESULT EEToProfInterfaceImpl::ExceptionUnwindFunctionEnter(FunctionID functionId)
{
    ...
    CLR_TO_PROFILER_ENTRYPOINT_EX(
        ...
        (LF_CORPROF,
        LL_INFO1000,
        "**PROF: ExceptionUnwindFunctionEnter. ThreadID: %p, functionId: %p\n",
        GetThreadNULLOk(),
        functionId));
...
HRESULT EEToProfInterfaceImpl::ExceptionUnwindFunctionLeave()
{
    ...
    CLR_TO_PROFILER_ENTRYPOINT_EX(
        ...
        (LF_CORPROF,
        LL_INFO1000,
        "**PROF: ExceptionUnwindFunctionLeave. ThreadID: %p\n",
        GetThreadNULLOk()));
...
HRESULT EEToProfInterfaceImpl::ExceptionUnwindFinallyEnter(FunctionID functionId)
{
    ...
    CLR_TO_PROFILER_ENTRYPOINT_EX(
        ...
        (LF_CORPROF,
        LL_INFO1000,
        "**PROF: ExceptionUnwindFinallyEnter. ThreadID: %p, functionId: %p\n",
        GetThreadNULLOk(),
        functionId));
...
HRESULT EEToProfInterfaceImpl::ExceptionUnwindFinallyLeave()
{
    ...
    CLR_TO_PROFILER_ENTRYPOINT_EX(
        ...
        (LF_CORPROF,
        LL_INFO1000,
        "**PROF: ExceptionUnwindFinallyLeave. ThreadID: %p\n",
        GetThreadNULLOk()));
...
HRESULT EEToProfInterfaceImpl::ExceptionCatcherEnter(FunctionID functionId, ObjectID objectId)
{
    ...
    CLR_TO_PROFILER_ENTRYPOINT_EX(
        kEE2PNoTrigger,
        (LF_CORPROF,
        LL_INFO1000, "**PROF: ExceptionCatcherEnter.        ThreadID: %p, functionId: %p\n",
        GetThreadNULLOk(),
        functionId));
...
HRESULT EEToProfInterfaceImpl::ExceptionCatcherLeave()
{
    ...
    CLR_TO_PROFILER_ENTRYPOINT((LF_CORPROF,
                                LL_INFO1000,
                                "**PROF: ExceptionCatcherLeave.        ThreadID: %p\n",
                                GetThreadNULLOk()));
    ...
    COR_PRF_SUSPEND_REASON suspendReason)
{
    ...
    CLR_TO_PROFILER_ENTRYPOINT_EX(
        ...
        (LF_CORPROF,
        LL_INFO100,
        "**PROF: RuntimeSuspendStarted. ThreadID %p.\n",
        GetThreadNULLOk()));
...
HRESULT EEToProfInterfaceImpl::RuntimeSuspendFinished()
{
    ...
    CLR_TO_PROFILER_ENTRYPOINT_EX(
        ...
        (LF_CORPROF,
        LL_INFO100,
        "**PROF: RuntimeSuspendFinished. ThreadID %p.\n",
        GetThreadNULLOk()));
...
HRESULT EEToProfInterfaceImpl::RuntimeSuspendAborted()
{
    ...
    CLR_TO_PROFILER_ENTRYPOINT_EX(
        ...
        (LF_CORPROF,
        LL_INFO100,
        "**PROF: RuntimeSuspendAborted. ThreadID %p.\n",
        GetThreadNULLOk()));
...
HRESULT EEToProfInterfaceImpl::RuntimeResumeStarted()
{
    ...
    CLR_TO_PROFILER_ENTRYPOINT((LF_CORPROF,
                                LL_INFO100,
                                "**PROF: RuntimeResumeStarted. ThreadID %p.\n",
                                GetThreadNULLOk()));
...
HRESULT EEToProfInterfaceImpl::RuntimeResumeFinished()
{
    ...
    CLR_TO_PROFILER_ENTRYPOINT((LF_CORPROF,
                                LL_INFO100,
                                "**PROF: RuntimeResumeFinished. ThreadID %p.\n",
                                GetThreadNULLOk()));
...
HRESULT EEToProfInterfaceImpl::RuntimeThreadSuspended(ThreadID suspendedThreadId)
{
    ...
    LOG((LF_CORPROF, LL_INFO1000, "**PROF: RuntimeThreadSuspended. ThreadID %p.\n",
         suspendedThreadId));
...
HRESULT EEToProfInterfaceImpl::RuntimeThreadResumed(ThreadID resumedThreadId)
{
    ...
    LOG((LF_CORPROF, LL_INFO1000, "**PROF: RuntimeThreadResumed. ThreadID %p.\n", resumedThreadId));
    ...
    /* [in] */ ClassID classId)
{
    ...
    CLR_TO_PROFILER_ENTRYPOINT((LF_CORPROF,
                                LL_INFO1000,
                                "**PROF: ObjectAllocated. ObjectID: %p.  ClassID: %p\n",
                                objectId,
                                classId));
...
HRESULT EEToProfInterfaceImpl::GetAssemblyReferences(LPCWSTR wszAssemblyPath, IAssemblyBindingClosure * pClosure, AssemblyReferenceClosureWalkContextForProfAPI * pContext)
{
    ...
    CLR_TO_PROFILER_ENTRYPOINT((LF_CORPROF,
                                LL_INFO10,
                                "**PROF: AssemblyReferenceClosureWalkStarted.  wszAssemblyPath: %p.\n",
                                wszAssemblyPath
                                ));
    HRESULT hr = S_OK;
